...
## Objetivo
Criar indicadores financeiros iniciais.
...
## Escopo
- Criar receitas por pedido pago.
- Criar despesas manuais simples.
- Exibir faturamento, despesas, lucro e formas de pagamento.
- Preparar exportação futura para Sheets.
- Não implementar contabilidade/fiscal na V1.
- Separar financeiro básico de relatórios avançados.
...
Pendências
Commit: feat(finance): add basic financial dashboard foundation
```
