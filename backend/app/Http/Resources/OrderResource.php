...
class OrderResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'print_required' => $this->print_required,
            'print_status' => $this->print_status,
            'ticket_generated_at' => $this->ticket_generated_at,
            'printed_at' => $this->printed_at,
            'print_waived_at' => $this->print_waived_at,
            'print_waived_by_user_id' => $this->print_waived_by_user_id,
            'print_waiver_reason' => $this->print_waiver_reason,
            'print_error_message' => $this->print_error_message,
            ...
            'latest_print_job' => new PrintJobResource($this->whenLoaded('latestPrintJob')),
            'print_job_events' => PrintJobEventResource::collection($this->whenLoaded('printJobEvents')),
