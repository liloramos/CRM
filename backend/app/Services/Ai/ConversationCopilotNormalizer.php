...
class ConversationCopilotNormalizer
{
    ...
    {
        $intents = ['GREETING', 'MENU_REQUEST', 'PRODUCT_CLARIFICATION', 'BUSINESS_HOURS_REQUEST', 'LOCATION_REQUEST', 'ORDER_CREATE', 'ORDER_CONTINUE', 'ORDER_CONFIRMATION', 'ORDER_CHANGE', 'ORDER_STATUS', 'PAYMENT_QUESTION', 'DELIVERY_QUESTION', 'GENERAL_QUESTION', 'GENERAL_MESSAGE', 'HUMAN_REQUEST', 'UNKNOWN'];
