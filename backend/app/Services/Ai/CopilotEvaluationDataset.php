...
final class CopilotEvaluationDataset
{
    ...
    public static function cases(): array
    {
        ...
        return [
            ...
            $case('n8 bife adicional ambiguo', 'n8 livre frango e porco mais um bife', 'ORDER_CREATE', $draft([$item('n8livre', ['meats' => ['porco'], 'extra_beef' => 1])]), 'n8-tradicional'),
            ...
            $case('n8 livre abreviado', 'n8 livre frg e porco', 'ORDER_CREATE', $draft([$item('n8tradicional', ['meats' => ['porco']])]), 'n8-tradicional', [], [], 'n8_livre', ['provider' => ['intent' => 'ORDER_CREATE', 'confidence' => .8, 'draft_order' => $draft([$item('n8tradicional', ['meats' => ['frango ao molho', 'porco']])]), 'suggested_reply' => 'Resposta sugerida para revisao humana.']]),
            $case('n8 bife excesso', 'n8 livre frango ao molho porco e 4 bifes', 'ORDER_CREATE', $draft([$item('n8livre', ['meats' => ['frango ao molho', 'porco']])]), 'n8-tradicional', ['INVALID_EXTRA_BEEF'], ['EXTRA_BEEF_QUANTITY'], 'beef', ['provider' => ['intent' => 'ORDER_CREATE', 'confidence' => .8, 'draft_order' => $draft([$item('n8livre', ['meats' => ['frango ao molho', 'porco'], 'extra_beef' => 4])]), 'suggested_reply' => 'Resposta sugerida para revisao humana.']]),
            $case('n8 bife quantidade 99', 'n8 livre com frango ao molho, porco e 99 bifes extra', 'ORDER_CREATE', $draft([$item('n8livre', ['meats' => ['frango ao molho', 'porco']])]), 'n8-tradicional', ['INVALID_EXTRA_BEEF'], ['EXTRA_BEEF_QUANTITY'], 'beef', ['provider' => ['intent' => 'ORDER_CREATE', 'confidence' => .8, 'draft_order' => $draft([$item('n8livre', ['meats' => ['frango ao molho', 'porco'], 'extra_beef' => 99])]), 'suggested_reply' => 'Resposta sugerida para revisao humana.']]),
            ...
            $case('n8 sem carne explicita', 'quero uma n8 livre sem carne', 'ORDER_CREATE', $draft([$item('n8livre', ['meat_mode' => 'none'])]), 'n8-tradicional'),
            $case('n8 sem escolha de carne', 'quero uma n8 livre', 'ORDER_CREATE', $draft([$item('n8livre')]), 'n8-tradicional', [], ['CARNE']),
            $case('n8 tres carnes', 'n8 livre porco frango ao molho e almondega', 'ORDER_CREATE', $draft([$item('n8livre', ['meats' => ['porco', 'frango ao molho', 'almondega']])]), 'n8-tradicional', [], [], 'n8_livre', ['provider' => ['intent' => 'ORDER_CREATE', 'confidence' => .8, 'draft_order' => $draft([$item('n8livre', ['meats' => ['porco', 'frango ao molho', 'almondega']])]), 'suggested_reply' => 'Resposta sugerida para revisao humana.']]),
