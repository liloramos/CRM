...
final class CopilotEvaluationDataset
{
    ...
    public static function cases(): array
    {
        ...
        return [
            ...
            $case('n8 livre ambiguo', 'quero n8 livre frango e porco', 'ORDER_CREATE', $draft([$item('n8livre', ['meats' => ['porco']])]), 'n8-tradicional', [], ['CARNE']),
            $case('n8 somente bife', 'n8 so bife', 'ORDER_CREATE', $draft([$item('n8livre', ['meat_mode' => 'beef_only'])]), 'n8-tradicional'),
            $case('n8 bife adicional ambiguo', 'n8 frango e porco mais um bife', 'ORDER_CREATE', $draft([$item('n8livre', ['meats' => ['porco'], 'extra_beef' => 1])]), 'n8-tradicional', [], ['CARNE']),
            ...
            $case('n9 bife adicional', 'n9 frango porco mais um bife', 'ORDER_CREATE', $draft([$item('n9livre', ['meats' => ['porco'], 'extra_beef' => 1])]), 'n9-tradicional', [], ['CARNE']),
            ...
            $case('n8 livre abreviado', 'n8 frg e porco', 'ORDER_CREATE', $draft([$item('n8tradicional', ['meats' => ['porco']])]), 'n8-tradicional', [], ['CARNE'], 'n8_livre', ['provider' => ['intent' => 'ORDER_CREATE', 'confidence' => .8, 'draft_order' => $draft([$item('n8tradicional', ['meats' => ['frango ao molho', 'porco']])]), 'suggested_reply' => 'Resposta sugerida para revisao humana.']]),
            ...
            $case('n9 bife adicional', 'uma n9 frango porco + bife', 'ORDER_CREATE', $draft([$item('n9livre', ['meats' => ['porco'], 'extra_beef' => 1])]), 'n9-tradicional', [], ['CARNE'], 'beef', ['provider' => ['intent' => 'ORDER_CREATE', 'confidence' => .8, 'draft_order' => $draft([$item('n9livre', ['meats' => ['frango ao molho', 'porco'], 'extra_beef' => 1])]), 'suggested_reply' => 'Resposta sugerida para revisao humana.']]),
            ...
            $case('multiturn duas n8', 'e entrega', 'ORDER_CHANGE', $draft([$item('n8livre', ['meats' => ['frango ao molho']]), $item('n8livre', ['meat_mode' => 'beef_only'])], 'delivery'), 'n8-tradicional', [], ['ADDRESS', 'CARNE'], 'multi_turn', ['messages' => ['quero duas n8 tradicionais', 'uma de frango ao molho', 'a outra so de bife', 'e entrega'], 'expected_products' => ['n8-tradicional', 'n8-tradicional']]),
            ...
            $case('multiturn troca carne', 'na verdade troca pra porco', 'ORDER_CHANGE', $draft([$item('n8livre', ['meats' => ['porco']])]), 'n8-tradicional', [], ['CARNE'], 'multi_turn', ['messages' => ['quero n8 tradicional de frango', 'na verdade troca pra porco']]),
