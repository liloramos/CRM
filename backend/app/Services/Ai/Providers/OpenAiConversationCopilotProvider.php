...
class OpenAiConversationCopilotProvider implements ConversationCopilotProviderInterface
{
    ...
    public function schema(): array
    {
        ...
        return [
            ...
            'properties' => [
                'intent' => ['type' => 'string', 'enum' => ['GREETING', 'MENU_REQUEST', 'PRODUCT_CLARIFICATION', 'LOCATION_REQUEST', 'ORDER_CREATE', 'ORDER_CHANGE', 'ORDER_STATUS', 'PAYMENT_QUESTION', 'DELIVERY_QUESTION', 'GENERAL_QUESTION', 'HUMAN_REQUEST', 'UNKNOWN']],
